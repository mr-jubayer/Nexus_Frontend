      ...
      className={({ isActive }) =>
        `${
          isActive
            ...
            : "lg:text-[#eaeaeae8] text-black dark:text-white/90  dark:lg:hover:text-green-600 lg:hover:text-green-600 lg:hover:bg-transparent dark:hover:bg-black1 hover:bg-green-100"
